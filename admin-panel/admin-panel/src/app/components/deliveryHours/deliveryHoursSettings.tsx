...
export default function DeliveryHoursSettings() {
  ...
  return (
    <div className="max-w-4xl space-y-6">
      ...
      {/* Configuration Form */}
      <form onSubmit={handleSave} className="space-y-6 rounded-3xl border border-border-theme bg-card p-6 shadow-sm">
        ...
        <div className="rounded-2xl border border-border-theme bg-background/60 p-5 space-y-3">
          <div className="flex items-center gap-2 text-xs font-bold text-slate-500 uppercase tracking-wider">
            <Eye className="h-4 w-4 text-primary" />
            <span>Customer Product Card Hover Preview Simulation:</span>
          </div>

          <div className="relative max-w-xs mx-auto rounded-2xl border border-border-theme bg-card p-4 shadow-md overflow-hidden group">
            <div className="h-32 w-full rounded-xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-400 mb-3 relative overflow-hidden">
              <Package className="h-10 w-10" />

              {/* Simulation Overlay */}
              <div className="absolute inset-0 bg-black/75 backdrop-blur-[2px] flex flex-col items-center justify-center p-3 text-center transition-all duration-300">
                <span className="rounded-full bg-rose-500/20 text-rose-400 border border-rose-500/30 px-2.5 py-0.5 text-[10px] font-black uppercase tracking-wider mb-1 flex items-center gap-1">
